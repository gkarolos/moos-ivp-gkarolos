#!/bin/bash -e
#----------------------------------------------------------
#  Script: launch.sh   (Lab 6 - Exercise 2: Alpha Bravo pShare)
#  Launches THREE MOOS communities: shoreside + alpha + bravo vehicles.
#----------------------------------------------------------
TIME_WARP=1
GUI="yes"
...
echo "Launching the BRAVO vehicle community with WARP: $TIME_WARP"
